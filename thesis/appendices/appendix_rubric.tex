...
This appendix reproduces the runtime rubric from \texttt{src/cultverify/resources/rubric.csv} at implementation commit \texttt{2e546a48ba0950e78f7bd244b5b37b7b475ccf2d}. The wording below is intentionally not paraphrased. This preserves a direct audit trail between the thesis and the executable scoring schema.
...
The runtime schema additionally permits \texttt{abstain} when the scorer cannot establish a defensible score for an applicable dimension. Abstention is an execution/scoring outcome and is therefore not encoded as a fourth anchor in the CSV rubric itself.
